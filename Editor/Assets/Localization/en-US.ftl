...
loc-menu-file-save = _Save Current RSI
loc-menu-file-save-as = Save Current as RSI Folder _As...
loc-menu-file-save-all = Save All Open RSIs
loc-menu-file-close = Close Current RSI
loc-menu-file-open-all-in = Open All RSIs in Folder...
loc-menu-file-save-all-to = Save All Open RSIs to Folder...
